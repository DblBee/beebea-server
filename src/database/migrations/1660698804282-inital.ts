...
export class inital1660698804282 implements MigrationInterface {
    name = 'inital1660698804282'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "animation_trait" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "assignment_number" integer NOT NULL, "name" character varying(128) NOT NULL, "element_type" character varying NOT NULL, "trait_type" character varying NOT NULL, "animation" character varying(128) NOT NULL, CONSTRAINT "UQ_fc868c3e222901d74d0aa5556a0" UNIQUE ("animation"), CONSTRAINT "ANIMATION_TRAIT_UNIQUE" UNIQUE ("element_type", "assignment_number", "trait_type"), CONSTRAINT "PK_9201a82dbfa4f84ea6b13794a79" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "color_trait" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "assignment_number" integer NOT NULL, "name" character varying(128) NOT NULL, "element_type" character varying NOT NULL, "trait_type" character varying NOT NULL, "hex" character(7) NOT NULL, "rgb" character varying(20) NOT NULL, CONSTRAINT "UQ_907e3d9d60f15ae1dbb8d5352e9" UNIQUE ("hex"), CONSTRAINT "UQ_e45040d9bcd8e73fac44afb1506" UNIQUE ("rgb"), CONSTRAINT "COLOR_TRAIT_UNIQUE" UNIQUE ("element_type", "assignment_number", "trait_type"), CONSTRAINT "PK_56b4301996c9d412417531a5bcc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "shape_trait" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "assignment_number" integer NOT NULL, "name" character varying(128) NOT NULL, "element_type" character varying NOT NULL, "trait_type" character varying NOT NULL, "shape" character varying(128) NOT NULL, CONSTRAINT "UQ_c784790aebf693a502cab46305a" UNIQUE ("shape"), CONSTRAINT "SHAPE_TRAIT_UNIQUE" UNIQUE ("element_type", "assignment_number", "trait_type"), CONSTRAINT "PK_a825106e5d72d1aa8b6387e8322" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "beebea" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" character varying(128) NOT NULL, "creepy_name" character varying(128) NOT NULL, "html_creepy_name" text NOT NULL, "birthday" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "generation" integer NOT NULL, "dna" character(66) NOT NULL, "bio" text, "is_ready" boolean NOT NULL DEFAULT true, "is_gestating" boolean NOT NULL DEFAULT false, "cooldown" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "cooldown_index" integer NOT NULL DEFAULT '0', "color_trait1_id" uuid, "color_trait2_id" uuid, "color_trait3_id" uuid, "color_trait4_id" uuid, "color_trait5_id" uuid, "color_trait6_id" uuid, "color_trait7_id" uuid, "color_trait8_id" uuid, "shape_trait1_id" uuid, "shape_trait2_id" uuid, "animation1_id" uuid, "hidden_trait_id" uuid, "sire_id" integer, "matron_id" integer, CONSTRAINT "UQ_9ab7ec8cb4e8b9d86c87f23bf04" UNIQUE ("dna"), CONSTRAINT "PK_95d26902692e2bad1e02c6dce91" PRIMARY KEY ("id"))`);
